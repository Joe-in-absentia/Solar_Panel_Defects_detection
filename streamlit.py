...
classes = ["Bird drop panel","Cleaned panel","Dust panel","Electrical problem","Physical damage",
                    "Snow problem"]
...
st.sidebar.markdown("---")
st.sidebar.info(""" Upload a Solar Panel Image.
    
    The Deep learing model will detect:
